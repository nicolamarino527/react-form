...
import titlesData from './List'; // Assicurati che questa importazione punti ai dati corretti
...
export default function Form() {
    ...
    const handleSubmit = (e) => {
        ...
        if (newArticle.trim()) {
            ...
            setArticleTitles(newTitles); // Aggiorniamo lo stato con il nuovo array
            setArticle(''); // Resettiamo l'input dopo l'aggiunta
        }
    }
